...
--
-- Name: appointments fk_appointment_cutomer; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT fk_appointment_cutomer FOREIGN KEY (customer_id) REFERENCES public.customers(customer_id);
